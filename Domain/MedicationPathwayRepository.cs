...
{
    public class MedicationPathwayRepository : BaseRepository
    {
        public MedicationPathwayRepository(dbfactory db) : base(db) { }
        ...
        public override JArray GetListJointImp(int pageSize, int pageIndex)
        {
            ...
            return _db.GetArray(@"
select ID,Code,Name,Introduction,IsActive 
from data_medicationpathway 
where IsDeleted=0
LIMIT ?p1,?p2
", offset,pageSize);
        }
